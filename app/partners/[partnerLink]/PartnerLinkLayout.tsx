      ...
      {isClient && (
        <>
          <ContentWrapper className={`min-h-[95.3vh] h-full relative`}>
            <Header navbarStyles="w-full px-[50px] pb-[5px] pt-[3px] bg-[#2c3e50] h-[50px] flex justify-between items-center" src={`/assets/partner/${data.id}.png`} height={40} width={40} title={data.title} extraStyle="text-white" page="partner" data={data} headerSelect="services" />
